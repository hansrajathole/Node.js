...
const Feed = () => {
  ...
  return (
    <div className=" h-screen w-full bg-black text-white flex justify-center p-8 relative">
      <div className="w-[20%] h-full flex  flex-col items-center border-r-[1px]">
        <div className="">
        ...
        <div className=" flex flex-col ">
          <div className="mt-6 flex gap-6 text-[1.2em]">
      ...
      <div className="w-[80%] h-full border-r-[1px] overflow-auto flex flex-col gap-5">
        {posts?.map((post, index) => (
          <div
            key={index}
            className=" flex flex-col ml-48"
          >
            <div className=" flex flex-col gap-3">
              ...
              <div>
              <img src={post.media} alt="Profile" className="w-80" />
              <p>{post.caption}</p>
              </div>
            </div>
          </div>
