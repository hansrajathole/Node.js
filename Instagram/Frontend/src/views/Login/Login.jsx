...
import login from '../../assets/home-phones.png' 
const Login = () => {
  ...
  return (
    <main className="flex items-center justify-center min-h-screen bg-black">
        ...
        <section className="p-8 rounded-lg shadow-lg border-[1px] border-amber-50 w-full max-w-md ">
        ...
        <div className=" text-white flex justify-center ">
          ...
          >
            ...
            <div className='text-white mt-2 p-3 flex justify-center'>
